...
public class ApiPostResponse {
    ...
    public ApiPostResponse(int id, long timestamp, AuthUserResponse user, String title, String announce, int likeCount, int dislikeCount, int commentCount, int viewCount) {
        this.id = id;
